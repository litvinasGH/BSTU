#include "pch.h"
#include "Registry.h"
/*Этот файл Registry.cpp отвечает за низкоуровневую работу с реестром Windows. Его главная задача — прописать DLL-библиотеку в системе так, чтобы COM-клиенты могли найти компонент по его имени (ProgID) или уникальному идентификатору (CLSID).*/

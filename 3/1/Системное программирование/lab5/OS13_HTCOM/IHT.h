...
struct HTHANDLE;
struct Element;
/*Это заголовочный файл IHT.h, который определяет COM-интерфейс вашего компонента. В архитектуре COM интерфейс — это «контракт» или абстрактный базовый класс, который содержит только объявления методов без их реализации.*/

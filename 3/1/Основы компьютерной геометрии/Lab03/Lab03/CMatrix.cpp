...
#include "CMatrix.h"
#include <random>
using namespace std; //setparam spacetowindow
CMatrix::CMatrix() //создаёт матрицу 1x1, заполняет нулями.
{
	n_rows = 1;
	n_cols = 1;
...
//-------------------------------------------------------------------------------
CMatrix::CMatrix(int Nrow, int Ncol) //создаёт матрицу заданного размера, заполняет нулями.
// Nrow - число строк
// Ncol - число столбцов
{
	n_rows = Nrow;
